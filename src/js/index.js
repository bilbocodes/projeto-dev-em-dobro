...
function delessionatechar() {
  const personagemSelected = document.querySelector(".personagem.selected");
  personagemSelected.classList.remove("selected");
}

function delessionate() {
  const botaoSelected = document.querySelector(".botao.selected");
  botaoSelected.classList.remove("selected");
}
